  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0F9FA] relative overflow-hidden px-4">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        {/* Card */}
        <Card className="p-10 bg-white/70 backdrop-blur-2xl relative overflow-hidden border-white">
                ...
                <div className="space-y-4">
                  <div className="group">
                    ...
                    <Input
                      ...
                      onBlur={handleBlur}
                      className={errors.username && touched.username ? "ring-2 ring-red-500/20" : ""}
                    />
                  ...
                  <div className="group">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className={errors.password && touched.password ? "ring-2 ring-red-500/20" : ""}
                    />
